...
if type docker-compose > /dev/null 2>&1; then
    ...
    curl -sSL "https://get.daocloud.io/docker/compose/releases/download/${COMPOSE_VERISON}/docker-compose-$(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose
